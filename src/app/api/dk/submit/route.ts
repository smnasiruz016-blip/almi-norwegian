...
// Danish engine and echoes productive self-ratings. DB persistence of attempts is
...
import { gradeObjective } from "@/lib/dk/grading";
import { isObjectiveTask, isFreeSkill } from "@/lib/dk/types";
import type {
  ObjectiveAnswer,
  DanishSkill,
  DanishTaskType,
